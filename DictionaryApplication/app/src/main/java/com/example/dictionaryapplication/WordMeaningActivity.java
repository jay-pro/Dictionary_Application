...
import com.example.dictionaryapplication.fragments.FragmentAntonyms;
import com.example.dictionaryapplication.fragments.FragmentDefinition;
import com.example.dictionaryapplication.fragments.FragmentExample;
import com.example.dictionaryapplication.fragments.FragmentSynonyms;
...
public class WordMeaningActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
                ...
                tts = new TextToSpeech(WordMeaningActivity.this, new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int status) {
                        ...
                        if(status == TextToSpeech.SUCCESS){
                            ...
                            Log.e("error","Initializtion Failed!");
                        }
                    }
                });
            }
        ...
        //tablayout
        @SuppressLint("WrongViewCast") TabLayout tabLayout = (TabLayout) findViewById(R.id.tabLayout);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId() == android.R.id.home)//press Back icon - cái drawable/ic_arrow_back tự tạo
        {
            //onBackPressed();
            if(startedFromShare){
